...
**Mode E:** Read `harness/mode-e.md` for the full Mode E flow. It uses the harness build-and-verify pipeline (`harness/` directory) with OPC roles as evaluators. The harness files can be updated independently.
